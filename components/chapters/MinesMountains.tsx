      ...
      <div className="relative grid gap-5 sm:grid-cols-2">
        {peaks.map((quest, i) => (
          <motion.button
            ...
            className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4 text-left backdrop-blur-sm transition hover:border-slate-300/40"
          >
            <div
            ...
            <h3 className="mb-1.5 text-xl font-bold text-white">{quest.title}</h3>
            <p className="mb-3 text-sm text-white/70">{quest.tagline}</p>
